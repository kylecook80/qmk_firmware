...
[_NUM] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, KC_MINS, KC_UNDS, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_PIPE,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, KC_PLUS, KC_EQL,  _______, _______, KC_LBRC, KC_RBRC, _______, _______, KC_BSLS,
...
[_FUNC] = LAYOUT_planck_grid(
    ...
    _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, NUM_MODE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
